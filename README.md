...
5. Redesign the API to reduce reliance on runtime errors, favour statically verified code, and fix convention issues such as lack of async suffixes. This means making it more predictable, even at the cost of convenience (documents shouldn't be accessible from anywhere at any time).
